...
const TrendingGames = ({ gameList }) => {
  ...
  return (
    <div className="mt-5 md:block">
      <h2 className="h-10 font-bold text-[22px] dark:text-white text-black  uppercase tracking-wider">
        Trending Games
      </h2>
              ...
              <div className="rounded-lg text-center group lg:hover:scale-110 transition-all duration-300 ease-in-out cursor-pointer p-1">
                <div>
                  <img
                    ...
                    alt="img"
                  />
                  <h2 className="dark:text-white text-[12px] font-bold text-start text-black uppercase pt-3 px-5">
                    {item.name}
                  </h2>
                  <h2 className="dark:text-white text-[10px] font-semibold text-start text-black pt-1 px-6">
                    {item.playtime} hrs
                  </h2>
                </div>
              </div>
